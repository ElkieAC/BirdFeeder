...
if bird_detected:
    ...
    if species_name:
        ...
        modified_image_path = os.path.join("/home/birdfeeder/BirdRecognition/imageToPost", modified_image_filename)
...
if num_pictures_in_folder > max_num_pictures:
    ...
    pictures_in_folder.sort(key=lambda x: os.path.getctime(os.path.join("/home/birdfeeder/BirdRecognition/imageToPost", x)))
